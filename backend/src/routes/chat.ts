...
// 发送消息
router.post('/:id/message', authenticateToken, async (req: AuthRequest, res: Response) => {
  try {
...
// 模拟AI回复生成函数
function generatePastSelfResponse(userMessage: string, memoryRecord: any): string {
  const responses = [
